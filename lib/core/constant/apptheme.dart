...
ThemeData themeEnglish = ThemeData(
  ...
  appBarTheme: AppBarTheme(
    ...
    titleTextStyle: const TextStyle(color: AppColor.primaryColor, fontWeight: FontWeight.bold, fontFamily: "PlayfairDisplay", fontSize: 25),
  ...
  textTheme: const TextTheme(
    ...
    bodyLarge: TextStyle(height: 2, color: AppColor.grey, fontWeight: FontWeight.bold, fontSize: 14),
